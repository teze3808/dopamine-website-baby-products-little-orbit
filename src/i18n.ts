...
export const copies:Record<Locale,Copy> = {
  ...
  en:{
    ...
    checkoutEyebrow:'Little Orbit checkout',checkoutTitle:'One last step. Keep imagining.',checkoutIntro:'We never ask for a phone number, real address, or payment details.',method:'ORBIT PASS',displayOnly:'Display only',destination:'Imaginary destination (optional)',destinationEmpty:'Prefer not to say',districts:['Hong Kong Island','Kowloon','New Territories','Outlying Islands','Far side of the Moon'],acknowledgement:'I understand this is a simulated order with no payment or product delivery.',order:'Place simulated order',successEyebrow:'Order in orbit',success:'Your order is in orbit!',successSub:'This was a simulated order. No payment was taken and nothing will be delivered.',continue:'Take another orbit',cleared:'Local data cleared',
